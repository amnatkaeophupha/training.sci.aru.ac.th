...
$route['dashboard/participants/(:num)/certificate/(:num)'] = 'dashboard/participant_certificate/$1/$2';
...
$route['admin/batches/(:num)/evaluation'] = 'Admin/batches/evaluation/$1';
...
$route['admin/members/store'] = 'Admin/members/store';
$route['admin/members/update/(:num)'] = 'Admin/members/update/$1';
$route['admin/members/delete/(:num)'] = 'Admin/members/delete/$1';
...
$route['admin/certificates'] = 'Admin/certificates/index';
$route['admin/certificates/template/(:num)'] = 'Admin/certificates/template/$1';
$route['admin/certificates/issue/(:num)'] = 'Admin/certificates/issue/$1';
$route['admin/certificates/issue-batch/(:num)'] = 'Admin/certificates/issue_batch/$1';
$route['admin/certificates/cancel/(:num)'] = 'Admin/certificates/cancel/$1';
$route['admin/certificates/view/(:num)'] = 'Admin/certificates/view/$1';
$route['admin/certificates/email/(:num)'] = 'Admin/certificates/email/$1';
$route['admin/certificates/email-batch/(:num)'] = 'Admin/certificates/email_batch/$1';
...
$route['evaluation/(:any)/certificate'] = 'evaluation/certificate/$1';
